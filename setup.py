...
# Package meta-data.
NAME = 'pyjop'
DESCRIPTION = 'Python API wrapper for the game JOY OF PROGRAMMING'
URL = 'https://store.steampowered.com/app/2216770/JOY_OF_PROGRAMMING__Software_Engineering_Simulator/'
...
REQUIRED = [
    ...
    'simple-pid',
    'statsmodels',
    'opencv-contrib-python-headless', #remove ffmpeg
    'nicegui==1.1.5', #remove docutils, keep bidict
    'gymnasium',
    'neatpy',
    'mypy',
    'tinygrad',
